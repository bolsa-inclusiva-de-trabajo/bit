...
public class User {
    ...
    @JsonIgnore
    @Transient
    private Job jobShowInContacts;


    public Job getJobShowInContacts() {
        return jobShowInContacts;
    }


    public void setJobShowInContacts(Job jobShowInContacts) {
        this.jobShowInContacts = jobShowInContacts;
    }
